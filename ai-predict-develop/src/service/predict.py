...
from constants import Config, Feature, Intervals, TimeAndPrice
...
def predict(interval, data):
    ...
    try:
        ...
        # + output
        dataRaw = data[TimeAndPrice+ feature_cols]
        dataAI = dataRaw.copy()
        ...
        realValues = trainingSet[:, :len(TimeAndPrice)] 
        trainingSet = trainingSet[:, len(TimeAndPrice):]
